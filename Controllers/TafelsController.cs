...
namespace D_Einder_Dylaan_MVC.Controllers
{
    public class TafelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,User,Menu,Rekening")] Tafel tafel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,User,Menu,Rekening")] Tafel tafel)
        {
            if (id != tafel.Id)
            {
                return NotFound();
