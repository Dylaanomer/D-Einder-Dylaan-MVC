...
namespace D_Einder_Dylaan_MVC.Controllers
{
    public class IngredientensController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Naam,Hoeveelheid")] Ingredienten ingredienten)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Naam,Hoeveelheid")] Ingredienten ingredienten)
        {
