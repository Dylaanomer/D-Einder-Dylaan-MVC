...
namespace D_Einder_Dylaan_MVC.Migrations
{
    public partial class ADDBASICSTUFF : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Bestelling = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Tijd = table.Column<int>(type: "int", nullable: false),
                    Tafel = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Categorien = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tijd = table.Column<int>(type: "int", nullable: false),
                    Tafel = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MenuKeuzes = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
